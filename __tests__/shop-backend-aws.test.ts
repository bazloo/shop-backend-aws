import { handler as productsHandler } from "../src/product-service/lambdas/getProducts";
import { handler as  productHandler } from "../src/product-service/lambdas/getProduct";
